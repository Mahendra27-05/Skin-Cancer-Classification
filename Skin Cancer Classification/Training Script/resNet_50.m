...
%% STEP 4: Load Pretrained Model - CHOOSE ONE:
% Options: 'resnet18', 'resnet50', 'googlenet', 'mobilenetv2', 'vgg16'
modelChoice = 'resnet50';  % CHANGE THIS
...
% Connect new layers
lgraph = connectLayers(lgraph, lastLayerName, 'fc_new');

fprintf('Using pretrained model: %s\n', modelChoice);
